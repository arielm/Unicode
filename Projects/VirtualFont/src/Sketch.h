 ...
 *
 * 10) USING PREBUILT hb AND icu-common LIBS FOR OSX AND iOS (LIKE ON ANDROID)
 *
 * 11) FIXING REGRESSION (INTRODUCED IN COMMIT 604c7ab) AFECTING (AT LEAST) HEBREW AND THAI
 */
