 ...
 * TODO:
 *
 * 0) POSSIBILITY TO UNLOAD/RELOAD VirtualFont
 *    - IMPLIES A SYSTEM FOR UNLOADING/RELOADING "RELATED" ActualFont INSTANCE
 *      (PROVIDING THEY'RE NOT SHARED WITH OTHER VirtualFont INSTANCES)
 *
 * 0) ActualFont: POSSIBILITY TO LOAD FROM MEMORY...
 *
 * 0) VirtualFont: ROBUST XML LOADING...
 *
 * 1) ADJUST FONTS:
 *    - iOS:
