 ...
 * TODO:
 *
 * 0) THROW ONLY EXCEPTIONS OF TYPE FontException:
 *    - NECESSARY IF WE WANT TO ASK USERS TO ENCLOSE
 *      FontManager::getFont() CALLS INSIDE TRY/CATCH BLOCKS
 *
 * 0) WE NEED A SYSTEM FOR LOGGING A MESSAGE "ONLY ONCE":
 *    - NECESSARY, E.G. IF CALLING FontManager::getFont() MANY TIMES
 *      DURING THE SAME FRAME AND THE SAME EXCEPTION IS THROWN EACH TIME
 *
